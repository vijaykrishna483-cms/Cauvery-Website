...
const Admin = ({ complaints, onDelete, onUpdate }) => {
  ...
  return (
    <div className='flex flex-row bg-[#1b1c21a5] button relative z-20 mb-[7vh] md:w-[50vw] w-[80vw] button px-[4vw] md:px-[2vw] py-[2vh] rounded-2xl justify-between items-center'>
      <div className='flex flex-col gap-[5px] justify-center w-[75%] items-left'>
        <div className='flex md:flex-row flex-col gap-[10px] md:items-center align-middle'>
        ...
        <p className='text-[#616060] text-xl font-bold'>{complaints.ContactNo}</p>
